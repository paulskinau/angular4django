...
var AppComponent = (function () {
    ...
    AppComponent.prototype.submitClicked = function (terrain) {
        var _this = this;
        this.robotService.getPath(terrain).subscribe(function (result) { return _this.result = result; }, function (error) { return _this.result = error; });
    };
    return AppComponent;
}());
AppComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__robot_service__["a" /* RobotService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__robot_service__["a" /* RobotService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__robot_service__["a" /* RobotService */]) === "function" && _a || Object])
], AppComponent);
...
var RobotService = (function () {
    function RobotService(http) {
        this.http = http;
        this.robotsUrl = "http://localhost:8000/api/robot/";
    }
    ;
    RobotService.prototype.getPath = function (terrain) {
    ...
    RobotService.prototype.extractData = function (res) {
        var body = res.json();
        if (body.error) {
            return body.error;
        }
